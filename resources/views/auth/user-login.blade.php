...
<div class="container">
  <div class=" login-container adminlogin">
    <div class="logo-img inline">
       <img src="{{ $logoUrl }}" alt=""  data-src="{{ $logoUrl }}" width="180px
          " height="auto"/>
          </div>
        ...
        <div class="alert alert-danger hidden">
            ...
            @endif
     <form id="login-form" class="login-form" role="form" method="POST" action="/{{ $hospital['url_slug']}}/login" data-parsley-validate>
