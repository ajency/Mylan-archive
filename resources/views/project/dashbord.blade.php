...
<div class="col-sm-4">
  <div class="row">
    <a class="btn btn-primary pull-right m-t-10" id="btnSave" title="Download this page as a printable PDF"><i class="fa fa-print"></i> Get PDF
      ...
      <a href="{{ url($hospital['url_slug'].'/'.$project['project_slug'].'/patients/create') }}" class="btn btn-primary pull-right m-t-10 m-r-15"><i class="fa fa-plus"></i> Add Patient</a>
      @endif
    </div>
  </div>
            ...
            <div class="pull-right m-r-5 patient-search">
              ...
              <option class="ttuc" value="">-select patient-</option>
               @foreach($patients as $patientData)
                 <option  value="{{ $patientData['id'] }}" class="ttuc patient-refer{{ $patientData['reference_code'] }}">{{ $patientData['reference_code'] }}</option>
               @endforeach
              </select>
            </div>
          </div>
...
<tr>
  ...
  <td>
    <div class="lst-sub text-center p-t-20">
      ...
      <!--span class="sm-font">Last Submission  <b></b></span><br>
      <span class="sm-font">Next Submission  <b></b></span-->
    </div>
  </td>
