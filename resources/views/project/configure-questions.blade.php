                ...
                <div class="parent-option-container options-list_container">
                  <div class="row options-list m-t-15">
                    ...
                    <div class="col-sm-4">
                      ...
                      <span class="delete-option-error-message alert alert-danger cust-alert-padd "><i class="fa fa-exclamation-triangle"></i> You cannot delete this option before saving newly added options.</span>
                    </div>
