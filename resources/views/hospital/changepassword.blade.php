...
<form class="form-no-horizontal-spacing col-sm-9" id="form-condensed" method="POST" action="{{ url($hospital['url_slug'].'/changepassword') }}" data-parsley-validate>
      ...
      <form class="form-no-horizontal-spacing" id="form-condensed">
         ...
         <div class="form-actions">
            <div class="text-right">
               ...
               <a href="{{ url($hospital['url_slug'].'/') }}"><button class="btn btn-default btn-cons-md" type="button"><i class="fa fa-ban"></i> Cancel</button></a>
            </div>
         </div>
      </form>
   </div>
