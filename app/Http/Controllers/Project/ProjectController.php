    ...
    public function setBaseline($projectId,$patient,$referenceId){
        $response = new ParseQuery("Response");
          ...
          if(empty($responseData)){
              ...
              $responseObjData->set("comparedToBaseLine", 0);
              $responseObjData->set("comparedToPrevious", 0);
              ...
              $responseObjData->set("baseLineTotalGreenFlags", 0);
              $responseObjData->set("previousTotalRedFlags", 0);
