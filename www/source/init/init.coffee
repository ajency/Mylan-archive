...
.controller 'InitCtrl', ['Storage','App','$scope', 'QuestionAPI','$q', '$rootScope', 'Push', '$ionicPlatform'
	, (Storage, App, $scope, QuestionAPI, $q, $rootScope, Push, $ionicPlatform) ->

		$ionicPlatform.ready ->
			ParsePushPlugin.on 'receivePN', (p) ->
